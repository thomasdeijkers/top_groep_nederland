        ...
        with conn.cursor() as cursor:
            cursor.execute(
                ...
                INSERT INTO relations (
                    ...
                    status, source, owner, availability, hourly_rate, invoice_obs_number,
                    invoice_payment_method, invoice_customer_number, kvk_number,
                ...
                VALUES (
                    ...
                    %(hourly_rate)s, %(invoice_obs_number)s, %(invoice_payment_method)s,
                    %(invoice_customer_number)s, %(kvk_number)s, %(vat_number)s, %(notes)s,
        ...
        with conn.cursor() as cursor:
            cursor.execute(
                ...
                SET relation_type = %(relation_type)s,
                    ...
                    invoice_obs_number = %(invoice_obs_number)s,
                    invoice_payment_method = %(invoice_payment_method)s,
                    invoice_customer_number = %(invoice_customer_number)s,
...
def _relation_payload(data: dict, relation_type: str) -> dict:
    ...
    return {
        ...
        "invoice_obs_number": data.get("invoice_obs_number"),
        "invoice_payment_method": data.get("invoice_payment_method"),
        "invoice_customer_number": data.get("invoice_customer_number"),
